...
public class StoreInformationMemory : VectorStoreMemory
{

    public const string COLLECTION_NAME = "information";
    ...
    public StoreInformationMemory (IRGEmbeddingCache embeddingCache)
        : base(embeddingCache)
    {
    ...
    public override ChatCompletionsFunctionToolDefinition GetToolDefinition()
    {
        ...
        {
            Name = this.ToolName,
            Description = "Find information about the store, including address, phone number, hours, or directions.",
